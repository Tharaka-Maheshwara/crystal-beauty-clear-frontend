...
<button onClick={handleSubmit} className="px-5 py-2.5 text-sm cursor-pointer font-medium text-white bg-green-500 border h-[50px] border-gray-300 rounded-lg w-[200px] m-1 text-center hover:bg-green-800 hover:text-white focus:ring-4 focus:ring-gray-100 transition-all">Add Product</button>
</div>
